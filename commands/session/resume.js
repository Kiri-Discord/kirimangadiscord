...
exports.run = async(client, interaction) => {
    ...
    return client.manga.resumeReading({ sessionId: session.sessionId }, interaction); 
}
...
exports.info = {
    ...
    .setName('resume')
    .setDescription('Resume a reading session from your session list')
    .addStringOption(option => option.setName('id').setDescription('ID of the session that you want to read').setRequired(true))
}