...
exports.run = async(client, interaction) => {
    ...
    if (session.currentPage === 1) return interaction.followUp({ content: 'You are already at the last page <:hutaoWHEEZE:1085918596955394180>', ephemeral : true });
