...
module.exports = async(client, interaction) => {
        ...
        try {
            if (subOptions) {
                if (subOptions.subCommandName && subOptions.subCommandGroupName) {
                    ...
                    if (interaction.isAutocomplete()) return command.autocomplete(client, interaction);
                    else {
            ...
            if (interaction.isAutocomplete()) return commandFile.autocomplete(client, interaction);
            else {
        ...
        if (!interaction.isAutocomplete()) return interaction.reply({
